...
namespace RE {
	...
	void setup_graphics_pipeline_2D_opaque_only(
		...
		vk_rColorBlendAttachment.blendEnable = VK_FALSE;
		vk_rColorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT;
