...
#define MIN_MONITOR_WIDTH_FOR_CALCULATION 1
#define MIN_MONITOR_HEIGHT_FOR_CALCULATION 1
#define MAX_MONITOR_WIDTH_FOR_CALCULATION 1920
#define MAX_MONITOR_HEIGHT_FOR_CALCULATION 1080
