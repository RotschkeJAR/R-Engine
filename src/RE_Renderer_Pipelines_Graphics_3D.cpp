...
namespace RE {
	...
	void setup_graphics_pipeline_3D(
		...
		vk_rInputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
		vk_rInputAssembly.primitiveRestartEnable = VK_FALSE;
		...
		vk_rRasterization.cullMode = VK_CULL_MODE_BACK_BIT;
