...
//================ Enumerations
	...
	enum Input {
		...
		RE_INPUT_KEY_PLUS = 0x36, /* + */
		RE_INPUT_KEY_CTRL_RIGHT = 0x37,
		RE_INPUT_KEY_CTRL_LEFT = 0x38,
		RE_INPUT_KEY_ALT_RIGHT = 0x39, /* AltGr */
		RE_INPUT_KEY_ALT_LEFT = 0x3A,
		RE_INPUT_KEY_SHIFT_RIGHT = 0x3B,
		RE_INPUT_KEY_SHIFT_LEFT = 0x3C,
		RE_INPUT_KEY_MENU = 0x3D,
		RE_INPUT_KEY_TAB = 0x3E,
		RE_INPUT_KEY_ENTER = 0x3F,
		RE_INPUT_KEY_ESCAPE = 0x40,
		RE_INPUT_KEY_BACKSPACE = 0x41,
		RE_INPUT_KEY_ARROW_LEFT = 0x42,
		RE_INPUT_KEY_ARROW_RIGHT = 0x43,
		RE_INPUT_KEY_ARROW_UP = 0x44,
		RE_INPUT_KEY_ARROW_DOWN = 0x45,
		RE_INPUT_KEY_DELETE = 0x46,
		RE_INPUT_KEY_INSERT = 0x47,
		RE_INPUT_KEY_HOME = 0x48,
		RE_INPUT_KEY_END = 0x49,
		RE_INPUT_KEY_BEGIN = 0x4A, /* Pos1 */
		RE_INPUT_KEY_PRINT_SCREEN = 0x4B,
		RE_INPUT_KEY_SCROLL_LOCK = 0x4C,
		RE_INPUT_KEY_PAUSE = 0x4D,
		RE_INPUT_KEY_PAGE_UP = 0x4E,
		RE_INPUT_KEY_PAGE_DOWN = 0x4F,
		...
		RE_INPUT_KEY_LESS = 0x60, /* < */
		RE_INPUT_KEY_GREATER = 0x61, /* > */
		RE_INPUT_KEY_BAR = 0x62, /* | */
