...
#define RE_VK_OPAQUE_GAME_OBJECT_SUPBASS 0U
#define RE_VK_TRANSPARENT_GAME_OBJECT_SUPBASS RE_VK_OPAQUE_GAME_OBJECT_SUPBASS

#define RE_VK_SEMAPHORES_PER_FRAME_COUNT 2U
#define RE_VK_OPAQUE_GAME_OBJECT_SEMAPHORE_INDEX 0U
#define RE_VK_TRANSPARENT_GAME_OBJECT_SEMAPHORE_INDEX 1U
