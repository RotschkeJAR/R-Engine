...
namespace RE {
	...
	bool create_renderer_buffers() {
		...
		const VulkanQueueCollection queues = aRenderTasks[0].queues_of_functions(au32FunctionIndices, sizeof(au32FunctionIndices) / sizeof(au32FunctionIndices[0]), false);
