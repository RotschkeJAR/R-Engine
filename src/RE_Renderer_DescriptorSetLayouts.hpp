...
#define __RE_RENDERER_DESCRIPTOR_SET_LAYOUTS_H__ 1

#include "RE_Renderer_Internal.hpp"

namespace RE {

#define RE_VK_GAME_OBJECTS_DESC_SET_BINDING_COUNT                3
...
#define RE_VK_GAME_OBJECTS_DESC_SET_TOTAL_COUNT_BINDING_INDEX    2
